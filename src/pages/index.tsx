    ...
    <section id="experience">
      ...
      <section>
        ...
        <section>
          ...
          <p>Sole developer that created the College's first web presence and responsible for designing, developing, and maintaining various web applications:
            <ul>
              <li><strong>Facilities Management System:</strong> used by the entire college community (faculty, staff, and students) to request facility repairs and Facilities Management to respond to requesters, store and document requests, and assign jobs to workers.</li>
              <li><strong>Grade Point Average Calculator:</strong> accessed the College’s AS400/DB2 database to calculate a student’s current cumulative GPA. Application also allowed the user to calculate the quality points and GPA needed to achieve a particular GPA in a subsequent semester when taking a certain number of credits.</li>
              <li><strong>Faculty Directory Update:</strong> used by College Relations staff to update faculty profiles that were featured on The College of New Rochelle’s website.</li>
              <li><strong>Board of Trustees Document Portal:</strong> used by college staff to upload Board of Trustees documents to the web so that Board of Trustees members may download crucial documents.</li>
              <li><strong>Grants Committee Portal:</strong> used by College Staff to upload Grants Committee documents to the web so the committee members may download documents.</li>
            </ul>
          </p>
          <div className="tech-container">
            <div className="pill">HTML</div>
    ...
    <section id="projects">
      ...
      <section>
        ...
        <section>
          ...
          <p>This application was created so that College of New Rochelle students, employees, and faculty could request maintenance work from the school's Facilities Management. The application:
            <ul>

      ...
      <div className="container">
        <div className="left">
          ...
          <div className="contact">
            <a href="https://github.com/Deryx" target="_blank">
            ...
            <a href="mailto:deryxescott@gmail.com" onMouseOver={(e) => e.currentTarget.style.backgroundColor='#FFF'} onMouseOut={(e) => e.currentTarget.style.backgroundColor='rgb(198, 196, 197)'} style={{backgroundColor: 'rgb(198, 196, 197)', width: '24px', height: '24px', padding: '1px', borderRadius: '8px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
              <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path id="svg_1" stroke-miterlimit="10" stroke-linejoin="round" stroke-linecap="round" stroke-width="3" stroke="#000000" fill="none" d="m22.6,26c-2.2,1.5 -5,2.3 -8,1.9c-5.5,-0.6 -10,-5.1 -10.6,-10.6c-0.7,-7.2 4.9,-13.3 12,-13.3c0.3,0 0.6,0 0.8,0c7.5,0.5 12.4,8.3 10,15.5l0,0.1c-0.5,1.4 -1.8,2.4 -3.3,2.4l0,0c-1.9,0 -3.5,-1.6 -3.5,-3.5l0,-7.5" />
                <path id="svg_2" stroke-miterlimit="10" stroke-linejoin="round" stroke-linecap="round" stroke-width="3" stroke="#000000" fill="none" d="m16,21l0,0c-2.2,0 -4,-1.8 -4,-4l0,-2c0,-2.2 1.8,-4 4,-4l0,0c2.2,0 4,1.8 4,4l0,2c0,2.2 -1.8,4 -4,4z" />
              </svg>
            </a>
          </div>
        </div>
